...
const ProfileStep3Form = (props) => {
  ...
  const [long, setLong] = useState(userData.longitude?userData.longitude:"");
  ...
  useEffect(() => {
    (async () => {
      const tagsList = await COMMON_APIS.getTags(JSON.parse(localStorage.getItem('userData')).event);
  ...
  return (
    ...
    <div className="welcomeProHead">
        <h2>          Welcome {props.userData.firstName} {props.userData.lastName}!
</h2>
        {/* <p>
        ...
        <ul className="welcomeTab">
          ...
          <a href="#">{1}</a>
            ...
            {/* <a onClick={()=>{props.hanldePageChange(1)}}>{1}</a> */}
          </li>
          <li className="active">
            <a href="#">{2}</a>
          </li>
        ...
        <div className="welcomeProInner">
          <div className="welcome3Inner">
            <div className="welcome3Text">
              ...
              <p>
                Visit the suggested for me tab within summit to be connected with
                like-minded attendees or view suggested sessions and experience
            ...
            <div className="welcome3Filed">
              ...
              /> */}
                ...
                <div className="form-group">
                  ...
                  {addressError == true && (
                    <div className="signupError_msg">This field is required</div>
                  )}
                </div>
                <div className="form-group">
